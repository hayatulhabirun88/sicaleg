...
class ReportPercaleg extends Component
{
    use WithPagination;
    ...
    public function submitForm()
    {
        ...
        ->selectRaw('dpts.*, calegs.name as nama_caleg, calegs.*, COUNT(*) as total_dukungan')
        ->where('calegs.id', $this->calegs)
        ->orderBy('total_dukungan', 'ASC')
        ->get();
    ...
    {
        return view('livewire.report-percaleg')->layout('report.percaleg');
    }
}
